...
const S = {
  ...
  card:     { background:'white', border:'1.5px solid #E2E8F0', borderRadius:14, padding:0, cursor:'pointer', textAlign:'center', display:'flex', flexDirection:'column', alignItems:'center', outline:'none', transition:'transform 0.1s, box-shadow 0.1s', overflow:'hidden' },
  photo:    { width:'100%', height:90, objectFit:'cover', display:'block', borderRadius:'14px 14px 0 0', flexShrink:0 },
  emoji:    { width:'100%', height:72, display:'flex', alignItems:'center', justifyContent:'center', fontSize:32, background:'#F8FAFC', flexShrink:0 },
  name:     { fontSize:13, fontWeight:700, color:'#0A1628', lineHeight:1.3, padding:'8px 10px 2px' },
  price:    { fontSize:12, fontWeight:700, color:'#3B82F6', paddingBottom:10 },
}
