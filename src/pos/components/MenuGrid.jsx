...
const S = {
  ...
  grid:     { display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(130px,1fr))', gap:10, overflowY:'auto', flex:1, alignContent:'start' },
  card:     { background:'white', border:'1.5px solid #E2E8F0', borderRadius:14, padding:0, cursor:'pointer', textAlign:'center', display:'flex', flexDirection:'column', alignItems:'center', outline:'none', transition:'transform 0.1s, box-shadow 0.1s', overflow:'hidden', height:'fit-content' },
  photo:    { width:'100%', height:80, objectFit:'cover', display:'block', borderRadius:'14px 14px 0 0', flexShrink:0 },
  emoji:    { width:'100%', height:60, display:'flex', alignItems:'center', justifyContent:'center', fontSize:28, background:'#F8FAFC', flexShrink:0 },
  name:     { fontSize:12, fontWeight:700, color:'#0A1628', lineHeight:1.3, padding:'6px 8px 2px' },
  price:    { fontSize:12, fontWeight:700, color:'#3B82F6', paddingBottom:8 },
}
