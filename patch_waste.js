...
let code = fs.readFileSync('src/backoffice/components/inventory/InvWaste.jsx', 'utf-8')
...
code = code.replace(
  /supabase\.from\("waste_records"\)\.select\("\*"\)\.order\("created_at",\s*\{\s*ascending:false\s*\}\)/,
...
fs.writeFileSync('src/backoffice/components/inventory/InvWaste.jsx', code)
console.log('patched InvWaste.jsx')
