...
async function run() {
  await supabase.from('stock_movements').delete().eq('ref', 'PROD-AUTO').eq('date', '2026-09-16')

  const prodDate = '2026-09-16'
  const moves = [
    { type: 'Production', ingredient_id: 'ING-046', ingredient_name: 'Daging Kambing', qty: -4000, unit: 'gr', ref: 'PROD-AUTO', note: 'Auto-fill forgotten production', date: prodDate },
    { type: 'Production', ingredient_id: 'ING-201', ingredient_name: 'Tulang Kambing', qty: -2000, unit: 'gr', ref: 'PROD-AUTO', note: 'Auto-fill forgotten production', date: prodDate },
    { type: 'Production', ingredient_id: 'ING-154', ingredient_name: 'Sate Kambing (sub)', qty: 228, unit: 'pcs', ref: 'PROD-AUTO', note: 'Auto-fill forgotten production', date: prodDate }
  ]
